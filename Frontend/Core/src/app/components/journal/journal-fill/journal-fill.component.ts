...
@Component({
    selector: 'journal-fill',
    templateUrl: './journal-fill.component.html',
    styleUrls: ['./journal-fill.component.css']
})

@Injectable()
export class JournalFillComponent implements OnInit {
